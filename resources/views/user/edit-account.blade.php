                            ...
                            <div class="tab-main">
                                ...
                                <div class="tab-content mt-40">
                                    <div class="tab-pane fade show active" id="account" role="tabpanel"
                                        ...
                                        <form action="{{ route('user.updateaccount', $account->id) }}" method="POST" autocomplete="off">
                                            @csrf
                                            @method('PATCH')
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="single-input">
                                                        ...
                                                        <input type="number" min="100000" max="999999" id="lName"
                                                            placeholder="XXXXXX" name="account_number"
                                                    ...
                                                    <div class="single-input" style="padding-top:20px;">
                                                        <select name="account_type" class="mt-6 w-100">
                                                            ...
                                                            @foreach ($acctypes as $item)
                                                                <option value="{{ $item->id }}" {{ ($account->account_type_id == $item->id) ? 'selected': ''}}>{{ $item->name }}
                                                                </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="btn-border">
                                                        <button class="cmn-btn" type="submit">Update Account
                                                            Details</button>
                                                    </div>
                                                </div>
                                            </div>
