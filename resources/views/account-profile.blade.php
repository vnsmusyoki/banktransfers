...
@section('title', 'User | Account Profile')
@section('content')
                        ...
                        <div class="owner-details">
                            <div class="profile-area">
                                <div class="profile-img">
                                    <img src="https://ui-avatars.com/api/?name={{ Auth::user()->name }}" alt="image" style="width:100px;height:100px;border-radius:50%">
                                </div>
                                <div class="name-area">
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-6">
                                                <div class="single-input">
                                                    ...
                                                    <input type="text" id="fName" placeholder="{{Auth::user()->name}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-input">
                                                    ...
                                                    <div class="row input-status d-flex align-items-center">
                                                        <div class="col-12">
                                                            <input type="text" id="email" placeholder="{{Auth::user()->email}}">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-input">
                                                    ...
                                                    <div class="row input-status d-flex align-items-center">
                                                        <div class="col-12">
                                                            <input type="text" id="phone" placeholder="{{Auth::user()->phone_number}}">
                                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="single-input">
                                                    ...
                                                    <div class="row input-status d-flex align-items-center">
                                                        <div class="col-12">
                                                            <input type="text" id="phone" placeholder="{{Auth::user()->id_number}}">
                                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-input">
                                                    ...
                                                    <input type="text" id="address" placeholder="{{Auth::user()->physical_address}}">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
